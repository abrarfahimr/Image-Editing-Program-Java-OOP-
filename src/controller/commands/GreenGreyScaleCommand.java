...
/**
 * Command class for green greyscale operation that extends AbstractGreyScale.
 */
public class GreenGreyScaleCommand extends AbstractGreyScaleCommand {
  /**
   ...
   */
  public GreenGreyScaleCommand(String sourceName, String destName, IImageStorage imageDatabase) {
  ...
  protected IOperation getGreyScaleOperation() {
    return new GreenGreyScaleOperation();
  }
}
