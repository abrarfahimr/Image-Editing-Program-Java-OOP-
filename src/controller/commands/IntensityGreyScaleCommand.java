...
/**
 * Command class for intensity greyscale operation that extends AbstractGreyScale.
 */
public class IntensityGreyScaleCommand extends AbstractGreyScaleCommand {
  /**
   ...
   */
  public IntensityGreyScaleCommand(
          String sourceName, String destName, IImageStorage imageDatabase) {
  ...
  protected IOperation getGreyScaleOperation() {
    return new IntensityGreyScaleOperation();
  }
}
