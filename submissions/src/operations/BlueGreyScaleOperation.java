 ...
 * It returns the blue value and creates a greyscale IImage object based on the value.
 */
public class BlueGreyScaleOperation extends AbstractGrayScaleOperation {
  /**
   ...
   * @return blue value of type integer.
   */
  @Override
