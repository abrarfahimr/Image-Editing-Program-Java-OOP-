...
/**
 * Command class for luma greyscale operation that extends AbstractGreyScale.
 */
public class LumaGreyScaleCommand extends AbstractGreyScaleCommand {
  /**
   ...
   */
  public LumaGreyScaleCommand(String sourceName, String destName, IImageStorage imageDatabase) {
  ...
  protected IOperation getGreyScaleOperation() {
    return new LumaGreyScaleOperation();
  }
}
