...
/**
 * Command class for red greyscale operation that extends AbstractGreyScale.
 */
public class RedGreyScaleCommand extends AbstractGreyScaleCommand {
  /**
   ...
   */
  public RedGreyScaleCommand(String sourceName, String destName, IImageStorage imageDatabase) {
  ...
  protected IOperation getGreyScaleOperation() {
    return new RedGreyScaleOperation();
  }
}
